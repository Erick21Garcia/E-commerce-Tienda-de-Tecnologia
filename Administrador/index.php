...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index.php"><b>Neo</b>Center</a>
  </div>
  <div class="card">
    <div class="card-body login-card-body">
      <h5 class="login-box-msg">Administrador</h5>
...
<?php
  if(isset($_REQUEST['login'])){
    ...
    $query="SELECT id,email,nombreU from usuarios where email='".$correo."' and contraseña='".$contra."'";
